...
lua5.1 ${JONCHKI} -v info --syscfg jonchkisys_windows_32.cfg --prjcfg jonchkicfg.xml --target windows_32 --finalizer flasher_cli.lua flasher_cli.xml
pushd windows_32/install
7z a -tzip -mx=9 ../../flasher_cli_windows_32bit.zip flasher_cli_windows_32bit
popd
lua5.1 ${JONCHKI} -v info --syscfg jonchkisys_windows_64.cfg --prjcfg jonchkicfg.xml --target windows_64 --finalizer flasher_cli.lua flasher_cli.xml
