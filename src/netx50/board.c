...
{
	{ .ucBus=BUS_SPI,      .ucUnit=0, .ucCS=0, .ucFlags=0, .acId="SPI0_CS0" },
	{ .ucBus=BUS_SPI,      .ucUnit=0, .ucCS=1, .ucFlags=0, .acId="SPI0_CS1" },
	{ .ucBus=BUS_SPI,      .ucUnit=0, .ucCS=2, .ucFlags=0, .acId="SPI0_CS2" },
	{ .ucBus=BUS_SPI,      .ucUnit=1, .ucCS=0, .ucFlags=0, .acId="SPI1_CS0" },
	{ .ucBus=BUS_SPI,      .ucUnit=1, .ucCS=1, .ucFlags=0, .acId="SPI1_CS1" },
	{ .ucBus=BUS_SPI,      .ucUnit=1, .ucCS=2, .ucFlags=0, .acId="SPI1_CS2" },
