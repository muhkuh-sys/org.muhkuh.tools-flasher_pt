...
typedef enum
{
	...
	FLASHER_CHIPTYP0_NETX4000       = 0x00000040,
} eFLASHER_CHIPTYP0;
...
typedef enum
{
	...
	FLASHER_IF0_NETX4000_PFSRAM     = 0x00040000,
	FLASHER_IF0_NETX4000_SPI        = 0x00080000,
	FLASHER_IF0_NETX4000_I2C        = 0x00100000,
	FLASHER_IF0_NETX4000_MMC        = 0x00200000
} eFLASHER_IF0;
