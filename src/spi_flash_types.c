...
const SPIFLASH_ATTRIBUTES_T atKnownSpiFlashTypes[] =
{
                ...
                .bEraseAndPageProgOpcode = 0x00,                                        /* eraseAndPageProgOpcode     */
                      ...
                      .uiInitCmd1_length = 2,                                           /* initCmd1_length            */
                             ...
                             .uiIdLength = 5,                                           /* id_length                  */
                              ...
                              .abIdMagic = {0x00, 0x1f, 0x46, 0x01, 0x00}               /* id_magic                   */
        },
                ...
                .bEraseAndPageProgOpcode = 0x00,                                        /* eraseAndPageProgOpcode     */
                      ...
                      .uiInitCmd1_length = 2,                                           /* initCmd1_length            */
                             ...
                             .uiIdLength = 5,                                           /* id_length                  */
                               .abIdSend = {0x9f, 0x00, 0x00, 0x00, 0x00},              /* id_send                    */
                               .abIdMask = {0x00, 0xff, 0xff, 0xff, 0xff},              /* id_mask                    */
                              .abIdMagic = {0x00, 0x1f, 0x46, 0x00, 0x00}               /* id_magic                   */
        },
        ...
        /* Atmel AT45DB081D */
        {
                     ...
                     .bEraseSectorOpcode = 0x50,                                        /* eraseSectorOpcode          */
                      .uiEraseChipCmdLen = 4,                                           /* erase chip command length  */
                         .abEraseChipCmd = {0xc7, 0x94, 0x80, 0x9a},                    /* erase chip command         */
                ...
                .bEraseAndPageProgOpcode = 0x82,                                        /* eraseAndPageProgOpcode     */
                      ...
                      .uiInitCmd1_length = 0,                                           /* initCmd1_length            */
                             ...
                             .uiIdLength = 5,                                           /* id_length                  */
                               .abIdSend = {0x9f, 0x00, 0x00, 0x00, 0x00},              /* id_send                    */
                               .abIdMask = {0x00, 0xff, 0xff, 0xff, 0xff},              /* id_mask                    */
                              .abIdMagic = {0x00, 0x1f, 0x27, 0x00, 0x00}               /* id_magic                   */
        },
        ...
        /* Atmel AT45DB642D */
        {
                ...
                .bEraseAndPageProgOpcode = 0x82,                                        /* eraseAndPageProgOpcode     */
                      .bReadStatusOpcode = 0xd7,                                        /* readStatusOpcode           */
                       .bStatusReadyMask = 0xbc,                                        /* statusReadyMask            */
                      .bStatusReadyValue = 0xbc,                                        /* statusReadyValue           */
                      .uiInitCmd0_length = 0,                                           /* initCmd0_length            */
                             .abInitCmd0 = {0},                                         /* initCmd0                   */
                      .uiInitCmd1_length = 0,                                           /* initCmd1_length            */
                             .abInitCmd1 = {0},                                         /* initCmd1                   */
                             .uiIdLength = 5,                                           /* id_length                  */
                               .abIdSend = {0x9f, 0x00, 0x00, 0x00, 0x00},              /* id_send                    */
                               .abIdMask = {0x00, 0xff, 0xff, 0xff, 0xff},              /* id_mask                    */
                              .abIdMagic = {0x00, 0x1f, 0x28, 0x00, 0x00}               /* id_magic                   */
        },
                ...
                .bEraseAndPageProgOpcode = 0x00,                                        /* eraseAndPageProgOpcode     */
                      ...
                      .uiInitCmd1_length = 0,                                           /* initCmd1_length            */
                             ...
                             .uiIdLength = 6,                                           /* id_length                  */
                               .abIdSend = {0x90, 0x00, 0x00, 0x00, 0x00, 0x00},        /* id_send                    */
                               .abIdMask = {0x00, 0x00, 0x00, 0x00, 0xff, 0xff},        /* id_mask                    */
                              .abIdMagic = {0x00, 0x00, 0x00, 0x00, 0xef, 0x10}         /* id_magic                   */
        },
                ...
                .bEraseAndPageProgOpcode = 0x00,                                        /* eraseAndPageProgOpcode     */
                      ...
                      .uiInitCmd1_length = 0,                                           /* initCmd1_length            */
                             ...
                             .uiIdLength = 6,                                           /* id_length                  */
                               .abIdSend = {0x90, 0x00, 0x00, 0x00, 0x00, 0x00},        /* id_send                    */
                               .abIdMask = {0x00, 0x00, 0x00, 0x00, 0xff, 0xff},        /* id_mask                    */
                              .abIdMagic = {0x00, 0x00, 0x00, 0x00, 0xef, 0x11}         /* id_magic                   */
        },
                ...
                .bEraseAndPageProgOpcode = 0x00,                                        /* eraseAndPageProgOpcode     */
                      ...
                      .uiInitCmd1_length = 0,                                           /* initCmd1_length            */
                             ...
                             .uiIdLength = 6,                                           /* id_length                  */
                               .abIdSend = {0x90, 0x00, 0x00, 0x00, 0x00, 0x00},        /* id_send                    */
                               .abIdMask = {0x00, 0x00, 0x00, 0x00, 0xff, 0xff},        /* id_mask                    */
                              .abIdMagic = {0x00, 0x00, 0x00, 0x00, 0xef, 0x12}         /* id_magic                   */
        },
        ...
        /* SST SST25LF20A or SST25VF020 */
        {
                ...
                .bEraseAndPageProgOpcode = 0x00,                                        /* eraseAndPageProgOpcode     */
                      ...
                      .bStatusReadyValue = 0x00,                                        /* statusReadyValue           */
                      .uiInitCmd0_length = 1,                                           /* initCmd0_length            */
                             .abInitCmd0 = { 0x50 },                                    /* initCmd0                   */
                      .uiInitCmd1_length = 2,                                           /* initCmd1_length            */
                             .abInitCmd1 = { 0x01, 0x00 },                              /* initCmd1                   */
                             .uiIdLength = 6,                                           /* id_length                  */
                               .abIdSend = {0x90, 0x00, 0x00, 0x00, 0x00, 0x00},        /* id_send                    */
                               .abIdMask = {0x00, 0x00, 0x00, 0x00, 0xff, 0xff},        /* id_mask                    */
                              .abIdMagic = {0x00, 0x00, 0x00, 0x00, 0xbf, 0x43}         /* id_magic                   */
        },
                ...
                .bEraseAndPageProgOpcode = 0x00,                                        /* eraseAndPageProgOpcode     */
                      ...
                      .uiInitCmd1_length = 2,                                           /* initCmd1_length            */
                             ...
                             .uiIdLength = 6,                                           /* id_length                  */
                               .abIdSend = {0x90, 0x00, 0x00, 0x00, 0x00, 0x00},        /* id_send                    */
                               .abIdMask = {0x00, 0x00, 0x00, 0x00, 0xff, 0xff},        /* id_mask                    */
                              .abIdMagic = {0x00, 0x00, 0x00, 0x00, 0xbf, 0x44}         /* id_magic                   */
        },
                ...
                .bEraseAndPageProgOpcode = 0x00,                                        /* eraseAndPageProgOpcode     */
                      ...
                      .uiInitCmd1_length = 2,                                           /* initCmd1_length            */
                             ...
                             .uiIdLength = 6,                                           /* id_length                  */
                               .abIdSend = {0x90, 0x00, 0x00, 0x00, 0x00, 0x00},        /* id_send                    */
                               .abIdMask = {0x00, 0x00, 0x00, 0x00, 0xff, 0xff},        /* id_mask                    */
                              .abIdMagic = {0x00, 0x00, 0x00, 0x00, 0xbf, 0x80}         /* id_magic                   */
        },
                ...
                .bEraseAndPageProgOpcode = 0x00,                                        /* eraseAndPageProgOpcode     */
                      ...
                      .uiInitCmd1_length = 2,                                           /* initCmd1_length            */
                             ...
                             .uiIdLength = 6,                                           /* id_length                  */
                               .abIdSend = {0x90, 0x00, 0x00, 0x00, 0x00, 0x00},        /* id_send                    */
                               .abIdMask = {0x00, 0x00, 0x00, 0x00, 0xff, 0xff},        /* id_mask                    */
                              .abIdMagic = {0x00, 0x00, 0x00, 0x00, 0xbf, 0x49}         /* id_magic                   */
        },
                ...
                .bEraseAndPageProgOpcode = 0x00,                                        /* eraseAndPageProgOpcode     */
                      ...
                      .uiInitCmd1_length = 2,                                           /* initCmd1_length            */
                             ...
                             .uiIdLength = 6,                                           /* id_length                  */
                               .abIdSend = {0x90, 0x00, 0x00, 0x00, 0x00, 0x00},        /* id_send                    */
                               .abIdMask = {0x00, 0x00, 0x00, 0x00, 0xff, 0xff},        /* id_mask                    */
                              .abIdMagic = {0x00, 0x00, 0x00, 0x00, 0xbf, 0x48}         /* id_magic                   */
        },
#endif
        /* PMC PM25LV512 */
        {
                     ...
                     .bWriteEnableOpcode = 0x06,                                        /* writeEnableOpcode          */
                       .bErasePageOpcode = 0x00,                                        /* erase page                 */
                     .bEraseSectorOpcode = 0xd7,                                        /* eraseSectorOpcode          */
                      .uiEraseChipCmdLen = 1,                                           /* erase chip command length  */
                         .abEraseChipCmd = {0xc7},                                      /* erase chip command         */
                        .bPageProgOpcode = 0x02,                                        /* pageProgOpcode             */
                            .bBufferFill = 0x00,                                        /* buffer fill opcode         */
                ...
                .bEraseAndPageProgOpcode = 0x00,                                        /* eraseAndPageProgOpcode     */
                      ...
                      .uiInitCmd1_length = 0,                                           /* initCmd1_length            */
                             ...
                             .uiIdLength = 7,                                           /* id_length                  */
                               .abIdSend = {0xab, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00},  /* id_send                    */
                               .abIdMask = {0x00, 0x00, 0x00, 0x00, 0xff, 0xff, 0xff},  /* id_mask                    */
                              .abIdMagic = {0x00, 0x00, 0x00, 0x00, 0x9d, 0x7b, 0x7f}   /* id_magic                   */
        },
                ...
                .bEraseAndPageProgOpcode = 0x00,                                        /* eraseAndPageProgOpcode     */
                      ...
                      .uiInitCmd1_length = 0,                                           /* initCmd1_length            */
                             ...
                             .uiIdLength = 7,                                           /* id_length                  */
                               .abIdSend = {0xab, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00},  /* id_send                    */
                               .abIdMask = {0x00, 0x00, 0x00, 0x00, 0xff, 0xff, 0xff},  /* id_mask                    */
                              .abIdMagic = {0x00, 0x00, 0x00, 0x00, 0x9d, 0x7c, 0x7f}   /* id_magic                   */
        },
                ...
                .bEraseAndPageProgOpcode = 0x00,                                        /* eraseAndPageProgOpcode     */
                      ...
                      .uiInitCmd1_length = 0,                                           /* initCmd1_length            */
                             ...
                             .uiIdLength = 5,                                           /* id_length                  */
                               .abIdSend = {0xab, 0x00, 0x00, 0x00, 0x00},              /* id_send                    */
                               .abIdMask = {0x00, 0x00, 0x00, 0x00, 0xff},              /* id_mask                    */
                              .abIdMagic = {0x00, 0x00, 0x00, 0x00, 0x11}               /* id_magic                   */
        },
                ...
                .bEraseAndPageProgOpcode = 0x00,                                        /* eraseAndPageProgOpcode     */
                      ...
                      .uiInitCmd1_length = 0,                                           /* initCmd1_length            */
                             ...
                             .uiIdLength = 5,                                           /* id_length                  */
                               .abIdSend = {0xab, 0x00, 0x00, 0x00, 0x00},              /* id_send                    */
                               .abIdMask = {0x00, 0x00, 0x00, 0x00, 0xff},              /* id_mask                    */
                              .abIdMagic = {0x00, 0x00, 0x00, 0x00, 0x12}               /* id_magic                   */
        },
                ...
                .bEraseAndPageProgOpcode = 0x0a,                                        /* eraseAndPageProgOpcode     */
                      ...
                      .uiInitCmd1_length = 0,                                           /* initCmd1_length            */
                             ...
                             .uiIdLength = 4,                                           /* id_length                  */
                              ...
                              .abIdMagic = {0x00, 0x20, 0x40, 0x12}                     /* id_magic                   */
        },
                ...
                .bEraseAndPageProgOpcode = 0x0a,                                        /* eraseAndPageProgOpcode     */
                      ...
                      .uiInitCmd1_length = 0,                                           /* initCmd1_length            */
                             ...
                             .uiIdLength = 4,                                           /* id_length                  */
                               .abIdSend = {0x9f, 0x00, 0x00, 0x00},                    /* id_send                    */
                               .abIdMask = {0x00, 0xff, 0xff, 0xff},                    /* id_mask                    */
                              .abIdMagic = {0x00, 0x20, 0x40, 0x13}                     /* id_magic                   */
        },
                ...
                .bEraseAndPageProgOpcode = 0x00,                                        /* eraseAndPageProgOpcode     */
                      ...
                      .uiInitCmd1_length = 0,                                           /* initCmd1_length            */
                             ...
                             .uiIdLength = 4,                                           /* id_length                  */
                               .abIdSend = {0x9f, 0x00, 0x00, 0x00},                    /* id_send                    */
                               .abIdMask = {0x00, 0xff, 0xff, 0xff},                    /* id_mask                    */
                              .abIdMagic = {0x00, 0x20, 0x20, 0x17}                     /* id_magic                   */
        },
                ...
                .bEraseAndPageProgOpcode = 0x00,                                        /* eraseAndPageProgOpcode     */
                      ...
                      .uiInitCmd1_length = 0,                                           /* initCmd1_length            */
                             ...
                             .uiIdLength = 4,                                           /* id_length                  */
                               .abIdSend = {0x9f, 0x00, 0x00, 0x00},                    /* id_send                    */
                               .abIdMask = {0x00, 0xff, 0xff, 0xff},                    /* id_mask                    */
                              .abIdMagic = {0x00, 0x20, 0x80, 0x14}                     /* id_magic                   */
        },
                ...
                .bEraseAndPageProgOpcode = 0x00,                                        /* eraseAndPageProgOpcode     */
                      ...
                      .uiInitCmd1_length = 0,                                           /* initCmd1_length            */
                             ...
                             .uiIdLength = 4,                                           /* id_length                  */
                               .abIdSend = {0x9f, 0x00, 0x00, 0x00},                    /* id_send                    */
                               .abIdMask = {0x00, 0xff, 0xff, 0xff},                    /* id_mask                    */
                              .abIdMagic = {0x00, 0x01, 0x02, 0x14}                     /* id_magic                   */
        },
                ...
                .bEraseAndPageProgOpcode = 0x00,                                        /* eraseAndPageProgOpcode     */
                      ...
                      .uiInitCmd1_length = 0,                                           /* initCmd1_length            */
                             ...
                             .uiIdLength = 4,                                           /* id_length                  */
                               .abIdSend = {0x9f, 0x00, 0x00, 0x00},                    /* id_send                    */
                               .abIdMask = {0x00, 0xff, 0xff, 0xff},                    /* id_mask                    */
                              .abIdMagic = {0x00, 0x01, 0x02, 0x15}                     /* id_magic                   */
        },
                ...
                .bEraseAndPageProgOpcode = 0x00,                                        /* eraseAndPageProgOpcode     */
                      ...
                      .uiInitCmd1_length = 0,                                           /* initCmd1_length            */
                             ...
                             .uiIdLength = 4,                                           /* id_length                  */
                               .abIdSend = {0x9f, 0x00, 0x00, 0x00},                    /* id_send                    */
                               .abIdMask = {0x00, 0xff, 0xff, 0xff},                    /* id_mask                    */
                              .abIdMagic = {0x00, 0xef, 0x40, 0x14}                     /* id_magic                   */
        },
                ...
                .bEraseAndPageProgOpcode = 0x00,                                        /* eraseAndPageProgOpcode     */
                      ...
                      .uiInitCmd1_length = 0,                                           /* initCmd1_length            */
                             ...
                             .uiIdLength = 4,                                           /* id_length                  */
                               .abIdSend = {0x9f, 0x00, 0x00, 0x00},                    /* id_send                    */
                               .abIdMask = {0x00, 0xff, 0xff, 0xff},                    /* id_mask                    */
                              .abIdMagic = {0x00, 0xef, 0x40, 0x15}                     /* id_magic                   */
        },
                ...
                .bEraseAndPageProgOpcode = 0x00,                                        /* eraseAndPageProgOpcode     */
                      ...
                      .uiInitCmd1_length = 0,                                           /* initCmd1_length            */
                             ...
                             .uiIdLength = 4,                                           /* id_length                  */
                               .abIdSend = {0x9f, 0x00, 0x00, 0x00},                    /* id_send                    */
                               .abIdMask = {0x00, 0xff, 0xff, 0xff},                    /* id_mask                    */
                              .abIdMagic = {0x00, 0xc2, 0x20, 0x15}                     /* id_magic                   */
        },
                ...
                .bEraseAndPageProgOpcode = 0x00,                                        /* eraseAndPageProgOpcode     */
                      ...
                      .uiInitCmd1_length = 0,                                           /* initCmd1_length            */
                             ...
                             .uiIdLength = 4,                                           /* id_length                  */
                               .abIdSend = {0x9f, 0x00, 0x00, 0x00},                    /* id_send                    */
                               .abIdMask = {0x00, 0xff, 0xff, 0xff},                    /* id_mask                    */
                              .abIdMagic = {0x00, 0xc2, 0x20, 0x16}                     /* id_magic                   */
        },
                ...
                .bEraseAndPageProgOpcode = 0x00,                                        /* eraseAndPageProgOpcode     */
                      ...
                      .uiInitCmd1_length = 0,                                           /* initCmd1_length            */
                             ...
                             .uiIdLength = 4,                                           /* id_length                  */
                               .abIdSend = {0x9f, 0x00, 0x00, 0x00},                    /* id_send                    */
                               .abIdMask = {0x00, 0xff, 0xff, 0xff},                    /* id_mask                    */
                              .abIdMagic = {0x00, 0xc2, 0x20, 0x17}                     /* id_magic                   */
        },
