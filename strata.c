...
static int            FlashIsset          (PFLASH_DEVICE ptFlashDev, unsigned long ulSector, unsigned long ulOffset, unsigned long ulCmd);
...
// ////////////////////////////////////////////////////
void FlashWriteCommand(PFLASH_DEVICE ptFlashDev, unsigned long ulSector, unsigned long ulOffset, unsigned long ulCmd)
{
	union
	{
...
// ////////////////////////////////////////////////////
int FlashIsset(PFLASH_DEVICE ptFlashDev, unsigned long ulSector, unsigned long ulOffset, unsigned long ulCmd)
{
  int            iRet       = FALSE;
